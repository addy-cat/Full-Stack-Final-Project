...
class PlayerInfoCard extends React.Component {
    render() {
        return (
            <div class="col-sm" style={{left: "500px", bottom: "600px"}}>
            <DropdownMenus />
            <div class="card " style={{width: '30rem'}}>
                  <div class= "card-body">
                    <h5 style={{fontSize: '25px'}} class="d-flex justify-content-center card-title">Player Information</h5>
                    <button style={{width: '9rem'}} type="button" className=" btn btn-primary mx-auto d-block mt-4">Start Game!</button>
                    <form>   
                    ...
                    <div className="d-flex justify-content-center" >
                        <img src="..." style={{ width: '5rem', height: '5rem'}} className="img-thumbnail mr-5 ml-5"></img>
                        <div >
                            <input style={{fontSize:'2.5rem'}} type="text" readonly class="col ml-2 mr-2 form-control-plaintext" id="staticVs" value="vs" />
                        </div>
                        <img src="..." style={{ width: '5rem', height: '5rem'}} className="img-thumbnail mr-5"></img>
                    </div>
              </div> 
              </div>
              </div>
